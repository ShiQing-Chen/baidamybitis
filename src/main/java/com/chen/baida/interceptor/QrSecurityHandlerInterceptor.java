 ...
 * @since 0.0.1
 */
public class QrSecurityHandlerInterceptor extends HandlerInterceptorAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger(QrSecurityHandlerInterceptor.class);
    ...
    private static final String URL_LOGIN = "/login/userInfo";
