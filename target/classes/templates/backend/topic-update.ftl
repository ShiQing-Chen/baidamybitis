...
<section class="content">
    <div class="box">
        <div class="box-body">
            <form id="form-add" class="form-horizontal" method="post" action="<@spring.url '/backend/doUpdateTopic'/>">
                <input type="hidden" id = "input-id" name="id" value="${updateTopicForm.id!}"/>
                <input type="hidden" id = "input-act-id" name="actId" value="${updateTopicForm.actId!}"/>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">选择活动</label>
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.actId"/>
                        <input type="text" class="form-control" id="input-act-name" name="actName" value="${updateTopicForm.actName!}" placeholder="输入关键词语检索">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.topicName"/>
                        <input type="text" class="form-control" id="input-topic-name" name="topicName" value="${updateTopicForm.topicName!}" placeholder="新高考政策的落地实施-张三">
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.speaker"/>
                        <input type="text" class="form-control" id="input-speaker" name="speaker" value="${updateTopicForm.speaker!}" placeholder="诸葛亮">
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.speakerIntro"/>
                        <input type="text" class="form-control" id="input-speaker-intro" name="speakerIntro" value="${updateTopicForm.speakerIntro!}" placeholder="课程帮中学校长、特级教师、省化学学会秘书长">
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.location"/>
                        <input type="text" class="form-control" id="input-location" name="location" value="${updateTopicForm.location!}" placeholder="综合楼四楼报告厅">
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.capacity"/>
                        <input type="number" class="form-control" id="input-capacity" name="capacity" value="${updateTopicForm.capacity!}" placeholder="200">
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.startTime"/>
                        <input type="text" class="form-control" style="width: 150px;" id="input-start-time" name="startTime"
                               placeholder="开始日期" value="${(updateTopicForm.startTime?string("yyyy-MM-dd HH:mm"))!}" readonly>
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <@spring.bind "updateTopicForm.endTime"/>
                        <input type="text" class="form-control" style="width: 150px;" id="input-end-time" name="endTime"
                               placeholder="结束日期" value="${(updateTopicForm.endTime?string("yyyy-MM-dd HH:mm"))!}" readonly>
                        <span class="text-danger"><@spring.showErrors ""/></span>
                    </div>
                </div>
                <div class="form-group">
